export function PlacesEarthPlanet(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M27.4995 10.0166L22.4995 18.6768L15.0466 5.76758L0.09375 31.6666H39.9994L27.4995 10.0166ZM4.42392 29.1666L15.0466 10.7676L21.0561 21.1761L16.4428 29.1666H4.42392ZM19.3296 29.1666L27.4995 15.0166L35.6693 29.1666H19.3296Z" fill="currentColor"/>
    </svg>
  );
} 
...
export function Mountains(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M5.04987 29.1018L3.2832 27.3334L15.7782 14.8401L23.3933 22.4551L34.9499 10.8984L36.7166 12.6651L23.3933 25.9901L15.7782 18.3751L5.04987 29.1018Z" fill="currentColor"/>
    </svg>
  );
}
...
<rect width="32" height="1.5" transform="translate(8 18.5)" fill="#565659"/>
<rect width="32" height="1.5" transform="translate(8 28)" fill="#565659"/>
</svg>
);
}
export function Close(props: React.SVGProps<SVGSVGElement>) {
  return (
<svg width="48" height="48" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
<rect width="32" height="1.5" transform="translate(36.0215 13.3934) rotate(135)" fill="#565659"/>
<rect width="32" height="1.5" transform="translate(13.3926 11.9792) rotate(45)" fill="#565659"/>
</svg>
);
}
...
<path d="M2 4V20H22V4H2ZM20.5 5.5V7.2321L12 12.14L3.5 7.2321V5.5H20.5ZM3.5 18.5V8.9641L12 13.8721L20.5 8.9641V18.5H3.5Z" fill="currentColor"/>
